...
const Login = () => {
    ...
    const { user, actualizarUsuario } = useUser(); //se obtiene el usuario y la función para actualizarlo
    const navigate = useNavigate(); //se utiliza para navegar entre páginas
