import { useState } from 'react'; //importar useState para manejar el estado de los inputs
...
const Registro = () => {
    ...
    const handleSubmit = (e) => { //para prevenir problemas de "renderización" 
        e.preventDefault(); // para prevenir que se recargue la página
    }

    const onChangeUsername = (e) => { //para cambiar el valor del input
        setUsername(e.target.value); //obiene el valor del input
    ...
    const CrearUser = () => {
        ...
        if(username === '' || name === '' || age === '' || password === ''){ // === para comparar el valor y el tipo de dato, comparacion estricta
            alert('Todos los campos son obligatorios');
            return;
        }

        const user_data = {  //se crea la data del usuario
            username: username,
            password:password,
            nombre:name,
            edad:age
    ...
    return (
        <div>
            <div className="h-screen md:flex font">
                ...
                <form className="bg-gris3" onSubmit={handleSubmit}> //onSubmit para prevenir que se recargue la página
                    ...
                    <input
                        ...
                        value={username} //value para que el input tenga un valor
                        onChange={onChangeUsername} //onChange para cambiar el valor del input
                        required
                        style={{ width: "100%" }}
                    />
                    </div>
                    ...
                    <input
                        ...
                        placeholder="Nombre"
                        value={name}
                        onChange={onChangeName} //onChange para cambiar el valor del input
                        required
                    />
                    </div>
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input
                        ...
                        name="phone"
                        id="phone"
                        placeholder="Edad" //placeholder para mostrar un texto en el input
                        value={age}
                    ...
                    <input
                        ...
                        value={password}
                        onChange={onChangePassword} //onChange para cambiar el valor del input
                        required
                    />
                    </div>
                    <button
